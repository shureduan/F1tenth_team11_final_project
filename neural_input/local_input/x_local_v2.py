...
OUTPUT_FEATURE_CSV = os.path.join(OUT_DIR, "x_local_features_clean.csv")
...
def compute_local_features(
    ...
    # x_local = [kappa_i, delta_kappa_i, delta_psi_i, d_left_i, d_right_i, d_inner_i]
    ...
    # Clean result table: only one row per segment with the final 6 local features
    df = pd.DataFrame({
...
if __name__ == "__main__":
    ...
    print(df_local.head())
    print("\nSaved columns:", list(df_local.columns))
